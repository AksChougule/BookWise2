...
class FakeLLMProvider(BaseProvider):
    ...
    async def generate_summary(self, *, prompt: str, max_output_tokens: int) -> ProviderResult:
        _ = (prompt, max_output_tokens)
        return ProviderResult(
            data={
                "summary": "This is a deterministic fallback summary generated by the fake provider.",
            },
            model=self.model,
            tokens_prompt=20,
    ...
    async def generate_structured(
        ...
        *,
        ...
        if schema_name == "summary_response":
            return await self.generate_summary(prompt=prompt, max_output_tokens=max_output_tokens)
